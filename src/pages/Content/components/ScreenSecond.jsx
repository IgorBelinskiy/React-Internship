...
const ScreenSecond = ({ screenSecondData }) => {
  const {
    title, mensCuts, infoPerson, available, timeDay
  } = screenSecondData;
...
ScreenSecond.propTypes = {
  screenSecondData: PropTypes.oneOfType([PropTypes.array, PropTypes.object]).isRequired
};
