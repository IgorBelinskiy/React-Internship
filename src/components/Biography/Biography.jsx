         ...
         <div className={classes.table}>
            ...
            <div className={classes.form}>
               ...
               <div className={classes.form_button}>
                  ...
                  <button onClick={() => { biographyObj.deleteLastPost() }} className={classes.del_btn}>Delete last event in list</button>
               </div>
               <div className={classes.form_action}>
                  ...
                  <div className={classes.action_items}>
                     <div onClick={() => { biographyObj.toMax() }} className={classes.items}>#1</div>
                     <div onClick={() => { biographyObj.toMin() }} className={classes.items}>#2</div>
                     <div onClick={() => { biographyObj.minMax() }} className={classes.items}>#3</div>
                     <div onClick={() => { biographyObj.rndm() }} className={classes.items}>#4</div>
                     <div onClick={() => { biographyObj.bubbleSort() }} className={classes.items}>#5</div>
                  </div>
               </div>
            </div>
         </div>
