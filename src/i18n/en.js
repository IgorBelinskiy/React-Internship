const TRANSLATIONS_EN = {
  homePage: {
    reactInternship: 'react internship',
    basicKnowledge: 'basic knowledge',
    biography: 'biography',
    api: 'api',
    author: 'igor belinskiy',
    design: 'design by dribbble'
  },
  contentPage: {
    html: `HTML stands for Hypertext Markup Language. It allows the user to create
    and structure sections, paragraphs, headings, 
    ...
    Consequently, Node.js represents a "JavaScript everywhere" paradigm,[6] unifying 
    web-application development around a single programming language, rather than different 
    languages for server-side and client-side scripts.`,
    npm: `npm (originally short for Node Package Manager)[4] is a package manager 
    for the JavaScript programming language.
    npm, Inc. is a subsidiary of GitHub (a subsidiary of Microsoft), that provides 
    hosting for software development and version control with the usage of Git.
    npm is the default package manager for the JavaScript runtime environment Node.js.`,
    git: `Git (/ɡɪt/)[7] is software for tracking changes 
    ...
    and support for distributed, non-linear workflows (thousands of parallel branches running on different systems).`
  },
  biographyPage: {
    event_1: 'Born',
    event_2: 'kindergarten',
    event_3: 'School',
    event_4: 'University',
    event_5: 'End of university studies',
    titleYear: 'Year',
    titleEvent: 'Event',
    addEvent: 'Add event',
    delEvent: 'Delete last event',
    sort: 'Sorting data',
