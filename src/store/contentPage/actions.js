import { TOGGLE_BTN_SCREEN_EIGHT, TOGGLE_BTN_SCREEN_FIRST, TOGGLE_OPTIONS_SCREEN_FIRST } from './types';
...
export const toggleOptionsScreenEight = (index) => ({ type: TOGGLE_OPTIONS_SCREEN_FIRST, index });
